...
const Footer = () => {
    return (
        <div className='footer lg:flex flex-col justify-center gap-7 overflow-hidden'>
            <div className="footer-top lg:flex lg:justify-between">
                <div data-aos="fade-right" className="footer-top-left">
                ...
                <div data-aos="fade-left" className="footer-top-right lg:flex items-center gap-9">
