...
const Services = () => {
    return (
        <div id='services' className='services flex flex-col justify-center items-center gap-20 overflow-hidden'>
            <div data-aos="fade-left" className='services-title'>
                <h1 className='text-4xl font-semibold'>My Services</h1>
            </div>
            <div data-aos="fade-right" className='services-container grid grid-cols-2 lg:grid-cols-3 gap-3  lg:gap-10 mb-10'>
